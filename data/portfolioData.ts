export interface PortfolioItem {
  ...
  stack: string;
  text: string;
  frontImage?: string; // For V2 modal
}
...
export const portfolioData: PortfolioData = {
  inProgress: {
    ...
    frontImage: '/images/portfolio/portfolio/modal/inProgress.webp',
  ...
  checkitup: {
    ...
    frontImage: '/images/portfolio/portfolio/modal/front-images/checkitup.webp',
    title: 'CheckItUp',
  ...
  jagahonlineMobile: {
    ...
    frontImage:
      '/images/portfolio/portfolio/modal/front-images/jaga-mobile.webp',
  ...
  jagahonlineWeb: {
    ...
    frontImage: '/images/portfolio/portfolio/modal/front-images/jaga-web.webp',
  ...
  heightsMobile: {
    ...
    frontImage: '/images/portfolio/portfolio/modal/front-images/heights.webp',
  ...
  upgrad: {
    ...
    frontImage: '/images/portfolio/portfolio/modal/front-images/upgrad.webp',
    title: 'Upgrad',
    stack: 'React js, Node js, MongoDB',
  ...
  wisoft: {
    ...
    frontImage: '/images/portfolio/portfolio/modal/front-images/wisoft.webp',
  ...
  tranquil: {
    ...
    frontImage: '/images/portfolio/portfolio/modal/front-images/tranquil.png',
    title: 'Tranquil',
  ...
  atss: {
    ...
    frontImage: '/images/portfolio/portfolio/modal/front-images/atss.webp',
    title: 'ATSS',
    stack: 'Next js',
  ...
  benu: {
    icon: '/images/portfolio/portfolio/benu.webp',
    image: '/images/portfolio/portfolio/modal/front-images/benu.webp',
    frontImage: '/images/portfolio/portfolio/modal/front-images/benu.webp',
    title: 'Benu (Web & Mobile)',
    stack: 'React Native, Node.js, MongoDB, OpenAI, Gemini',
    text: 'Benu is an AI-powered SaaS mobile application that helps users optimize their health and wellness journey. Built with React Native for cross-platform compatibility, the app features advanced AI integrations including RAG (Retrieval Augmented Generation), OpenAI, and Google Gemini for personalized health recommendations. The platform includes Apple and Google subscription management, Stripe payment integration, and is deployed with robust CI/CD pipelines. The backend leverages Node.js and MongoDB, with AWS infrastructure ensuring scalability and reliability.',
  },
  bltc: {
    icon: '/images/portfolio/portfolio/bltc.webp',
    image: '/images/portfolio/portfolio/modal/front-images/bltc.webp',
    frontImage: '/images/portfolio/portfolio/modal/front-images/bltc.webp',
    title: 'BLTC (Web & Mobile)',
    stack: 'React Native, Node.js, MongoDB, AI Integration',
    text: 'BLTC is a life transformational mobile application built with React Native that helps users achieve their wellness goals. The app features AI-powered meal planners, workout planners, guided meditations, and sleep stories. Users can log their meals and workouts to track progress over time. Built with sophisticated AI capabilities powered by OpenAI and Gemini APIs, the app provides personalized recommendations and intelligent automation. It includes full subscription management through Apple and Google Play, integrated Stripe payments, and automated CI/CD deployment pipelines. The robust backend architecture uses Node.js and MongoDB, hosted on AWS infrastructure to ensure high availability and performance.',
  },
};
